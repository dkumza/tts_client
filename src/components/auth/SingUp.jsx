...
export default function SignUp() {
   ...
   return (
      <div className="flex p-12 items-center  align-middle justify-center min-w-full min-h-screen">
         <div className="flex flex-col items-center justify-center align-middle mx-auto w-full max-w-md  px-12 py-20 bg-white shadow">
